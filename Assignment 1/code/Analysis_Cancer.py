...
plt.legend(loc='best')
plt.grid()
plt.savefig(fig_path + 'dtree_validation_curve_cancer2.png')
plt.clf()

# Parameter Tuning
params_name = {'max_features': range(2, 30, 1),
...
plt.legend(loc='best')
plt.grid()
plt.savefig(fig_path + 'ab_validation_curve_cancer2.png')
plt.clf()
...
plt.legend(loc='best')
plt.grid()
plt.savefig(fig_path + 'svm_validation_curve_cancer2.png')
plt.clf()


# Parameter Tuning
parameters = {'C': np.arange(1, 3, 0.1),
